...
function App() {
  ...
  const handleComplete =(index) =>{
    ...
    localStorage.setItem('completedTodos', JSON.stringfy(updatedCompletedArr));
    ...
    <div className="App">
      ...
      <div className='todo-input'>
        <div className='todo-input-item'>
          ...
          <input type='text' value={newTitle} onChange={(e)=>setNewTitle(e.target.value)} placeholder='Enter Task'/>
        </div>
        <div className='todo-input-item'>
      ...
      <div className='btn-area'>
        <button className={`secondaryBtn ${isCompleteScreen===false && 'active'}`} onClick={()=>setIsCompleteScreen(false)}>Pending Tasks</button>
